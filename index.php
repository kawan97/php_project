...
$select = $pdo->prepare('SELECT * FROM items  ORDER BY `items`.`id` DESC LIMIT '.$daspik.','. $articleno);
$select->setFetchMode(PDO::FETCH_ASSOC);
$select->execute();
...
<nav class="navbar navbar-expand navbar-dark bg-primary">
  ...
  <tbody id="searchs">
    ...
    <p class="font-weight-bold">All Data</p>
    <a class="btn btn-success" href="print_all.php" > Print All</a>
